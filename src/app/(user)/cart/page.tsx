...
export default function CartPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-gray-50">
      <Header />
      <main className="mx-auto w-full max-w-7xl px-3 py-8 pt-32 md:px-6 md:pt-36">
        <Link
          href="/homepage"
        ...
        <div className="mt-4 space-y-4">
          {items.length === 0 ? (
            ...
            items.map((it) => (
              <div
                key={it.id}
                className="grid grid-cols-[24px_1fr_120px_160px_120px_80px] items-center gap-3 bg-white px-4 py-5"
              >
                <Checkbox
                ...
                <div className="justify-self-end text-sm font-medium text-black">
                  {VND.format((it.price || 0) * it.quantity)}
                </div>
        ...
        {/* Footer actions */}
        <div className="mt-4 flex flex-col items-center justify-between gap-4 border bg-white px-4 py-4 md:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              className="ml-2 h-auto bg-[var(--bg-button)] px-6 py-3 font-semibold whitespace-nowrap text-[var(--text-inverse)] hover:bg-[var(--bg-button-hover)] disabled:bg-gray-300"
